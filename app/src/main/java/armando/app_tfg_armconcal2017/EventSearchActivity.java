...
public class EventSearchActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new EventSearchActivity.Info(EventSearchActivity.this).execute();
        new EventSearchActivity.CheckAssistance(EventSearchActivity.this).execute();
                        ...
                        if(userId.equals(user)){
                            ...
                            join.setOnClickListener(new View.OnClickListener(){
                                ...
                                public void onClick(View v) {
                                    new DeleteAssistant(EventSearchActivity.this).execute();
                                }
                            });
                ...
                ctx.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        join.setOnClickListener(new View.OnClickListener(){
                            ...
                            @Override
                            public void onClick(View v) {
                                new CreateAssistant(EventSearchActivity.this).execute();
                            }
                        });
                    }
                });
            ...
            if(assistance()){
                ctx.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        new UpdateNumber(EventSearchActivity.this).execute();
                        new CheckAssistance(EventSearchActivity.this).execute();
                        join.setOnClickListener(new View.OnClickListener(){
    ...
    public void onBackPressed() {
        new EventSearchActivity.Back(EventSearchActivity.this).execute();
    }
